...
class Core_Response
{
	...
	public function addError($error_in)//dodajBlad($error_in)
	{
...
//				$string = 'Hello {$name}. How are you on this fine {$dayofweek} morning';
//					
...
//				$vars = $result[1];
//				
//				Core_Narzedzia::drukuj($variableNames);
//				Core_Narzedzia::drukuj($vars);
