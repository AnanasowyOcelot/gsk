...
class Core_Zdjecie
{
    ...
    {
        imagejpeg($obrazek, Core_Config::get('server_path') . 'img/allegro_aukcje/' . 'temp.jpg', 75);
        $obrazek = file_get_contents(Core_Config::get('server_path') . 'img/allegro_aukcje/' . 'temp.jpg');
        unlink(Core_Config::get('server_path') . 'img/allegro_aukcje/' . 'temp.jpg');
    ...
    function dodaj_ramke($obrazek, $ramka_grubosc, $kolor_rgb)
    {
        ...
        $sciezka = Core_Config::get('server_path') . 'edycja/tmp/allegro_tmp.jpg';
