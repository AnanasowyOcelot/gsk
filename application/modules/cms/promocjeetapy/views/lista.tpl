...
<tr>
	...
	<th><a href="{$link}index/{$linkParams}col:kolejnosc">Kolejność</a></th>
</tr>
{foreach from=$lista  item=rekord}
	...
	<td><a class="linkEdit" href="{$link}edytuj/{$linkParams}{$primaryKeyName}:{$rekord->id}">{$rekord->kolejnosc}</a></td>
    </tr>
{/foreach}
</table>
