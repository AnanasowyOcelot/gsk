...
class klient_Controller extends Core_ModuleController
{
	...
	{
		$r = new Model_Klient((int)$o_requestIn->getParametr('id'));
		...
		$a_pole_tresc[$idJezyka] = $CKEditor->editor('r[opis]', $r->opis, $config);
		...
		$engine_indexResponse->dodajParametr('modul_name', $this->modul);
