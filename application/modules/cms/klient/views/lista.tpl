...
{foreach from=$lista  item=rekord}
	...
	<td><a class="linkEdit" href="{$link}edytuj/id:{$rekord->id}">{$rekord->imie}</a></td>	
	<td><a class="linkEdit" href="{$link}edytuj/id:{$rekord->id}">{$rekord->nazwisko}</a></td>	
	<td><a class="linkEdit" href="{$link}edytuj/id:{$rekord->id}">{$rekord->email}</a></td>	
	<td><a class="linkEdit" href="{$link}edytuj/id:{$rekord->id}">{$rekord->punkty}</a></td>	
	<td><a class="linkEdit" href="{$link}edytuj/id:{$rekord->id}">{$rekord->nr_karty}</a></td>	
	<td class="colAktywna">{if $rekord->aktywny}tak{/if}</td>
    </tr>
{/foreach}
</table>
