...
<div style="overflow:hidden; position:relative;">
	...
	<div class="formularz" style="float:left;">
        ...
        <div class="wiersz">
            ...
            <div class="fieldSet">
                <div><small>te numery nie są wyświetlane w karcie produktu i służą do identyfikacji wewnątrz systemu (np. importy z excela)</small></div>
        ...
        <div class="wiersz">
            ...
            <div class="fieldSet">
                <div class="field">
                    <input type="text" name="r[sztuk_w_opakowaniu]" value="{$r->sztuk_w_opakowaniu}" class="{$errors.sztuk_w_opakowaniu}"/>
                </div>
            </div>
        </div>
                ...
                {foreach from=$r->atrybuty key=atrybutNum item=atrybut}
                    <div class="field">
                        ...
                        <div class="fieldWrapper" style="width: 30%;">
                            nazwa: <input style="width: 60%;" type="text" name="r[atrybuty][nazwa][{$atrybut->id}]" value="{$atrybut->nazwa}" />
                        </div>
                        <div class="fieldWrapper" style="width: 62%; text-align: right;">
                            wartość: <input style="width: 78%;" type="text" name="r[atrybuty][wartosc][{$atrybut->id}]" value="{$atrybut->wartosc}" />
                        </div>
                    </div>
                {/foreach}
        ...
        <div class="wiersz">
            ...
            <div class="fieldSet">
                <div class="field">
                    <label><input type="radio" name="r[typ]" value="1" {if $r->typ eq 1 || $r->typ eq ''} checked{/if}/>pełny opis</label>
		        ...
		        {foreach from=$jezyki key=jezykId item=jezykSkrot}
		            <div class="field fieldInline">
		                <div class="fieldWrapper">
		                    ...
		                    <input type="checkbox" name="r[aktywny][{$jezykId}]" value="1" {if $r->aktywny[$jezykId]}checked="checked"{/if} />
		                </div>
		                <span class="jezyk"><span class="flag flag-{$jezykSkrot}" alt="{$jezykSkrot}" /></span>
		            </div>
		        {/foreach}
		...
		<div style="overflow:hidden; position:relative; margin-top: 30px;">
		    ...
		    {if $button_del==1}
		    	<a href="{$link}usun/id:{$r->id}" onclick="confirm('Czy na pewno usunąć produkt?');"><img src="{$img_path}buttons/button-del.png" style="float:right; padding-right:20px;"/></a>
		    {/if}
		</div>
		</div>
	<!-- FORMULARZ ------>
