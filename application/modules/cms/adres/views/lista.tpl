<form id="edycjaHurt" method="post">
    ...
    <table class="lista">
        <tr>
            ...
            <th><a href="{$link}index/{$linkParams}col:firma">Firma</a></th>
        ...
        {foreach from=$lista  item=rekord}
            <tr>
                ...
                <td><a class="linkEdit"
                       href="{$link}edytuj/{$linkParams}{$primaryKeyName}:{$rekord->id}">{$rekord->firma}</a></td>
                <td><a class="linkEdit"
                       href="{$link}edytuj/{$linkParams}{$primaryKeyName}:{$rekord->id}">{if $rekord->aktywny}tak{/if}</a>
                </td>
            </tr>
        {/foreach}
    </table>
