...
<tr>
	...
	<th><a href="{$link}index/{$linkParams}col:aktywny">Kolor</a></th>
</tr>
{foreach from=$lista  item=rekord}
    <tr>
        ...
        <td><a class="linkEdit" href="{$link}edytuj/{$linkParams}{$primaryKeyName}:{$rekord->id}">{$rekord->name}</a></td>
        <td class="colAktywna"><div style="width: 40px; height: 12px; background-color: {$rekord->color};">&nbsp;</div></td>
    </tr>
{/foreach}
</table>
