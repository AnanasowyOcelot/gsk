...
class Model_Api_AppDataGeneratorV2dot24
{
            ...
            if (isset($postData['promotions'])) {
                ...
                if (isset($postData['promotions']['orders'])) {
                    ...
                    foreach ($ordersData as $orderData) {
                        if (isset($orderData['remoteId']) && (int)$orderData['remoteId'] == 0) {
                            ...
                            //$order->id = (int)$orderData['remoteId'];
                            ...
                            $order->promocjaId = $orderData['promotionId'];
